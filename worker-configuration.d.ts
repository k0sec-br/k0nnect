/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d1f25fb944c2470b8eb446466466f2e5)
// Runtime types generated with workerd@1.20260811.1 2026-08-18 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	ENVIRONMENT: "production" | "development";
	APP_ORIGIN: "https://connect.k0sec.org" | "http://localhost:5173";
	...
	SERVER_REALTIME: DurableObjectNamespace<import("./worker/index").ServerRealtime>;
	SECURITY_GATES: DurableObjectNamespace<import("./worker/index").SecurityGate>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "SecurityGate" | "ServerRealtime";
	}
	interface ProductionEnv {
		DB: D1Database;
		ASSETS: Fetcher;
		ENVIRONMENT: "production";
		APP_ORIGIN: "https://connect.k0sec.org";
		REGISTRATION_MODE: "invite";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "APP_ORIGIN" | "REGISTRATION_MODE" | "REALTIME_ENABLED" | "TURNSTILE_ENABLED" | "TURNSTILE_SITE_KEY" | "PASSWORD_PEPPER" | "TURNSTILE_SECRET" | "REALTIME_APP_ID" | "REALTIME_APP_SECRET" | "TURN_KEY_ID" | "TURN_KEY_API_TOKEN">> {}
}
