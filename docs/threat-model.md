...
- **Enumeração/brute force:** mensagens genéricas, derivação dummy, rate limits combinados, cooldown e Turnstile. Risco residual: ataques distribuídos e custo de PBKDF2; monitorar taxas agregadas.
...
- **WebSocket/DoS:** limites antes e depois do upgrade, payload máximo e conexão única por usuário. Ataques volumétricos de camada de rede dependem das proteções Cloudflare.
